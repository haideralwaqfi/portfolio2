  ...
  return (
    <html lang="en" className="!scroll-smooth">
      <body
        ...
        <div className="bg-[#dbd7fb]  -z-10 absolute top-[-1rem] left-[-35rem] h-[31.25rem] w-[50rem] rounded-full blur-[10rem] sm:w-[68.75rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem] dark:bg-[#676394]"></div>
